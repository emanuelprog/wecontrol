    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "api/moai/add-participant/{id}").permitAll()
                        .requestMatchers(HttpMethod.POST, "api/moai/bid-monthly/{id}").permitAll()
                        .requestMatchers(HttpMethod.POST, "api/moai/pay-monthly/{id}").permitAll()
                        .requestMatchers(HttpMethod.POST, "api/moai/delete-bid/{id}").permitAll()
