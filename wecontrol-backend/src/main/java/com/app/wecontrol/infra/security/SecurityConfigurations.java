    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "api/moai-monthly/bid").hasRole("USER")
                        .requestMatchers(HttpMethod.PUT, "api/moai-monthly/bid/{id}").hasRole("USER")
                        .requestMatchers(HttpMethod.DELETE, "api/moai-monthly/bid/{id}").hasRole("USER")
